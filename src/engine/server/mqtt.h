...
public:
    CMqtt(const std::string& address, const std::string& clientID);
    virtual ~CMqtt();
    ...
    void Run() override;
    void Init() override;
    void Subscribe(const int& topic) override;
    void Publish(const int& topic, const std::string& payload) override;
    void Publish(const int& topic, const json& payload) override;
    void PublishWithResponse(const int& topic, const std::string& payload, const std::string& responseTopic) override;
    void WaitForResponse(const std::string& responseTopic, std::function<void(const std::string&)> callback) override;
    ...
    void RequestLogin(const int& clientId, const std::string& logintoken) override;
